...
b2DebugDraw.prototype.SetDrawScale = function (drawScaleX, drawScaleY) {
		this.m_drawScaleX = drawScaleX;
                this.m_drawScaleY = drawScaleY;
                this.m_drawScale = (this.m_drawScaleX + this.m_drawScaleY)/2
	}
b2DebugDraw.prototype.GetDrawScale = function () {
		return new b2Vec2(this.m_drawScaleX, this.m_drawScaleY);
	}
...
b2DebugDraw.prototype.ToWorldPoint = function(localPoint) {
	return new b2Vec2(localPoint.x / this.m_drawScaleX, this.Y(localPoint.y)/this.m_drawScaleY);
}
...
b2DebugDraw.prototype.DrawPolygon = function (vertices, vertexCount, color) {
		...
		this.m_sprite.graphics.moveTo(vertices[0].x * this.m_drawScaleX, vertices[0].y * this.m_drawScaleY);
		for (var i = 1; i < vertexCount; i++){
				this.m_sprite.graphics.lineTo(vertices[i].x * this.m_drawScaleX, vertices[i].y * this.m_drawScaleY);
		}
		this.m_sprite.graphics.lineTo(vertices[0].x * this.m_drawScaleX, vertices[0].y * this.m_drawScaleY);
...
b2DebugDraw.prototype.DrawSolidPolygon = function (vertices, vertexCount, color) {
		...
		this.m_sprite.moveTo(vertices[0].x * this.m_drawScaleX, this.Y(vertices[0].y * this.m_drawScaleY));
		for (var i = 1; i < vertexCount; i++){
				this.m_sprite.lineTo(vertices[i].x * this.m_drawScaleX, this.Y(vertices[i].y * this.m_drawScaleY));
		}
		this.m_sprite.lineTo(vertices[0].x * this.m_drawScaleX, this.Y(vertices[0].y * this.m_drawScaleY));
		this.m_sprite.fill();
...
b2DebugDraw.prototype.DrawCircle = function (center, radius, color) {
		...
		this.m_sprite.graphics.lineStyle(this.m_lineThickness, color.color, this.m_alpha);
		this.m_sprite.graphics.drawCircle(center.x * this.m_drawScaleX, this.Y(center.y * this.m_drawScaleY) , radius * this.m_drawScale);
...
b2DebugDraw.prototype.DrawSolidCircle = function (center, radius, axis, color) {
		...
		this.m_sprite.beginPath();
		this.m_sprite.arc(center.x * this.m_drawScaleX, this.Y(center.y * this.m_drawScaleY) , radius * this.m_drawScale, 0, Math.PI*2, true);
		this.m_sprite.fill();
		this.m_sprite.stroke();
		this.m_sprite.closePath();
	}
b2DebugDraw.prototype.DrawSegment = function (p1, p2, color) {
		...
		this.m_sprite.strokeSyle = this.ColorStyle(color, this.m_alpha);
		this.m_sprite.beginPath();
		this.m_sprite.moveTo(p1.x * this.m_drawScaleX, this.Y(p1.y) * this.m_drawScaleY);
		this.m_sprite.lineTo(p2.x * this.m_drawScaleX, this.Y(p2.y) * this.m_drawScaleY);
		this.m_sprite.stroke();
		this.m_sprite.closePath();		
...
b2DebugDraw.prototype.DrawTransform = function (xf) {
		...
		this.m_sprite.beginPath();
		this.m_sprite.moveTo(xf.position.x * this.m_drawScaleX, this.Y(xf.position.y * this.m_drawScaleY));
		this.m_sprite.lineTo((xf.position.x + this.m_xformScale*xf.R.col1.x) * this.m_drawScaleX, this.Y((xf.position.y + this.m_xformScale*xf.R.col1.y) * this.m_drawScaleY));
		this.m_sprite.stroke();
		this.m_sprite.closePath();
		...
		this.m_sprite.beginPath();
		this.m_sprite.moveTo(xf.position.x * this.m_drawScaleX, this.Y(xf.position.y * this.m_drawScaleY));
		this.m_sprite.lineTo((xf.position.x + this.m_xformScale*xf.R.col2.x) * this.m_drawScaleX, this.Y((xf.position.y + this.m_xformScale*xf.R.col2.y) * this.m_drawScaleY));
		this.m_sprite.stroke();
		this.m_sprite.closePath();
	}
// attributes
...
b2DebugDraw.prototype.m_drawScaleX =  1.0;
b2DebugDraw.prototype.m_drawScaleY =  1.0;
